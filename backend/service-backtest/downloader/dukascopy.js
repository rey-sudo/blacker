 ...
 */
async function downloadDukascopy(
  instrument,
  timeframe,
  yearsToBacktest,
  outputFileName
  ...
  try {
    ...
    console.log(
      `Rango de fechas: Desde ${fromDate.toISOString().split("T")[0]} hasta ${
    ...
    console.log(
      `(NOTA: La columna 'timestamp' contiene la hora de apertura del bar en milisegundos UTC.)`
    );
  } catch (error) {
