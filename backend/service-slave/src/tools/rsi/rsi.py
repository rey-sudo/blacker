...
def relative_strength_index(klines,mark=10,period=14, filename="rsi.png", show=False):
    """Calculates RSI from klines data and plots the RSI chart.
       The last 10 intervals are blue if RSI is below 32.
    """
    ...
    plt.axhline(32, linestyle="solid", color="green", label="Oversold (32)")
    
    # Highlight last 10 intervals where RSI is below 32
    if len(rsi) > 10:
