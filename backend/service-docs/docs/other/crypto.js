...
const config = {
  ...
  precioActual: 95,           // Precio actual de ASSET
  perdidaMaximaUSD: 100,          // Pérdida máxima aceptada en USD
  ...
  tamañoContratoEnUnidades: 100   // Para DASH: 0.01 lotes = 10 DASH, entonces 1 lote = 1000 DASH
};
